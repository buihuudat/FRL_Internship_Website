...
const SendEmail = () => {
  ...
  return isLoading ? (
    ...
    <Box sx={{ height: "80vh" }}>
      <Typography fontWeight={600} fontSize={40} align="center" color={"white"}>
        Get In Touch
      </Typography>
      <Typography
        align="center"
      ...
      >
        ...
        hight-authority links to each asset, paving the way for you grow your
      ...
      >
        ...
        >
          ...
          <Box sx={{ my: 5, display: "flex", flexDirection: "column", gap: 3 }}>
            <Box sx={{ display: "flex", alignItems: "center", gap: 5 }}>
              <LocalPhoneIcon sx={{ width: 60, height: 60, color: "white" }} />
            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: 5 }}>
              <LocationOnIcon sx={{ width: 60, height: 60, color: "white" }} />
              <Typography fontWeight={600} color={"white"}>
        ...
        >
          ...
          <Button variant="contained" color="error" onClick={handleSendEmail}>
            Send Message
          </Button>
        </Box>
      </Paper>
